...
import com.tyrengard.unbound.combat.events.UCStartedCombatEvent;
...
import com.tyrengard.unbound.combat.combatant.impl.DefaultMobCombatantTemplate;
import com.tyrengard.unbound.combat.combatant.impl.DefaultPlayerCombatantTemplate;
...
public final class CombatEngine extends AManager<UnboundCombat> implements Listener, Configured {
    ...
    public static CombatInstance getInstance(Combatant<?> defender, Combatant<?> attacker) {
    ...
    static ArrayList<CombatInstance> removeInstances(Combatant<?> combatant) {
