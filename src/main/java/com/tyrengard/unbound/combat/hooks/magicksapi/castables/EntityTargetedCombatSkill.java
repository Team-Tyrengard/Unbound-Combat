...
public interface EntityTargetedCombatSkill extends MagicksAPICombatSkill, EntityTargetedSkill {
    @Override
    default SkillFailureReason cast(SkillUser caster, Entity target) {
