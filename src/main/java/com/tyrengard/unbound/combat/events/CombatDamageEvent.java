...
public final class CombatDamageEvent extends Event implements Cancellable {
    ...
    public CombatDamageEvent(Damageable entity, double damage, Entity damager, CombatOutcome outcome) {
        this.entity = entity;
